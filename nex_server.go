...
func main() {
	...
	endpoint.ServerAccount = nex.NewAccount(types.NewPID(1), "Quazal Authentication", os.Getenv("PN_YKWB_KERBEROS_PASSWORD")))
	...
	authServer.Listen(os.Getenv("PN_YKWB_AUTHENTICATION_SERVER_PORT"))
}
